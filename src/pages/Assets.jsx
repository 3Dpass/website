        ...
        <div className="page-content-block first-page-block" id="general">
          <div className="page-content-inner">
            ...
            <div className="page-content-text">
              ...
              of an object and turning them into a sustainable digital
              identity known as the <Link to="/features#3drecognition-hash-id">HASH ID</Link>,{" "}
              by which the object can be recognized and distinguished from others 
              across the Internet.
            </div>
            <img
              className="page-img"
            ...
            <div className="page-content-text" id="general-hashid-many-to-many">
              ...
              it becomes independent of the environment, being defined by 
              mathematical equations rather than environmental distortion. The object itself
              can be reproduced in as many replications as needed, and within any environment modern
            ...
            />
            <div className="page-content-text">
              Explore this <Link to="/features#recognition-hash-id-case">case study</Link> to compare 
            ...
            <div className="page-content-text">
              ...
              principles. In contrast, replications or models are relative, heavily influenced by their 
            ...
            <ol className="page-content-text">
              <li>
                ...
                might be characterized as having its origin in the virtual realm as an idea or project. 
            ...
            <div className="page-content-text">
              Both recognition algorithms and manufacturing technologies provide a certain level of accuracy
              with which replications can be produced. The quality of the model is determined by the level 
...
{lego} {pig} {standing} {firmly}
            ...
            <div className="page-content-text">
             The formula is designed to be robust enough to be hashed and verified by network peers.
            </div>
            <div className="page-content-subtitle" id="general-process-overview">
              The process overview
            </div>
            <div className="page-content-text">
              This brief overview of the tokenization process will help in better understanding 
              what is going on "under the hood" when the object is submitted to The Ledger of Things 
              and how this can be compared to existing alternatives.
            </div>
            <ol className="page-content-text">
              <li>
               ...
               <br />
                ...
                is actually created by the app 
                leveraging recognition technology in the background and offline. 
                Explore this <Link to="/features#recognition-hash-id-case">case study</Link> to compare it 
                with conventional hashing methods used in alternative standards
                (e.g., <Link to="https://ethereum.org/en/developers/docs/standards/tokens/erc-1155/">ERC-1155</Link>).
              ...
              <li>
               ...
               <br />
                ...
                <Link to="features#ledger">The Ledger of Things</Link>. Explore the 
