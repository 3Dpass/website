      ...
      <div className="page-content">
        ...
        <div className="page-content-block" id="light">
          <div className="page-content-inner">
            ...
            <div className="page-content-text">
              Connect the wallet to The Ledger of Things network through 
              one of the <Link to="https://github.com/3Dpass/rpc-list/blob/main/list.txt">RPC API providers</Link> available.
            </div>
            <img
              className="page-img"
              style={{ marginBottom: "20px" }}
